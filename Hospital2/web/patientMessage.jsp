        ...
        <div class="wrap">
            <header>
                <div class="container">
                    ...
                    <nav>
                        <ul>
                            <li class="current"><a href="AdminAdd.jsp" class="m1">Patient Profile</a></li>
                            <li><a href="AdminEdit.jsp" class="m2">Apply for a loan</a></li>
                            <li><a href="patientMessage.jsp" class="m3">Message Account</a></li>
                            <li><a href="viewNotice.jsp" class="m4">View Notices</a></li>
                            <li><a href="AdminDeleteNotice.jsp" class="m4">Give Feedback</a></li>
            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <hr><div align="center">
                    <form action="DoctorSelect.jsp" method="post" >
                        <input type="submit" name="askQuery" value="Ask A Query"/>
                        
                    </form><br><br><br><br>
                    </div>
                    <div align="center">
                    <form action="viewDiagnosis.jsp" method="post" >
                        <input type="submit" class="button blue" name="askQuery" value="View The Diagnosis"/>
