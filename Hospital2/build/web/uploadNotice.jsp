            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <div class="inside" align="center">
                                            <div class="inside">
                        <h2>Upload <span>Notice</span></h2><hr>
                        ...
                        <form action="addnotice.jsp" method ="post">
                         ...
                         &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Enter Title : <input type="text" name="title" 
                                                 placeholder="Enter Notice Title" style="font-size:14px; font-family:'Comic Sans MS';font-weight:bold;"/><br> <br><br>
                            Enter Description : 
                            ...
                            <input  class=" black button" type="submit"  value="Upload Notice"/>
                             <br><br>
                             </form>
                    </div>
