        ...
        <div class="wrap">
            <header>
                <div class="container">
                    ...
                    <nav>
                        <ul>
                            <li class="current"><a href="patientMessage.jsp" class="m1">Go Back</a></li>
                            <!--<li><a href="viewNotice.jsp" class="m2">View Notices</a></li>
                            <li><a href="viewQuery.jsp" class="m3">View Queries</a></li>
                            <!--<li><a href="AdminDeleteNotice.jsp" class="m4">Upload notice</a></li>-->
            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <s:query var="rs">
                        select *from msg where reciever='${sessionScope.name}'
                    </s:query>
                    <div class="inside" align="center">
                        <h2><span>Patients Inbox</span></h2><hr><br><br>
        ...
        <c:if test="${s.count mod 2 eq 0}">
            <tr class="gridrow" >
               ...
               <!-- <td>${data.email}</td>
                ...
                <td>${data.dept}</td>-->
                <td>
                  <!--  <a href="${data.location}"><img src="${data.image}" ></td>
                <td >-->
                    <a href="doctorReply.jsp?id=${data.sno}&patient=${data.sender}">
                        <img title="Reply To Patient" src="images/reply.png"/>
                    </a> 
                    <!-- <a onclick="return deleteConfirmation()" href="deletepatient.jsp?id=${data.sno}">
