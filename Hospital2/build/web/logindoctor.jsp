            ...
            <section>				
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <form  method="post" action="verifyUserDoctor">
                            <h1> Sign up </h1> 
                            <p> 
                            ...
                            <p> <label for="name" class="uname" data-icon="u">Enter your gender</label>
                                <input id="name" name="gender" required  placeholder="Enter your Name"/>
                            </p>
                            <p>
                                <label for="dept" class="uname" data-icon="u">Please Enter Your Department </label>
                                <input id="dept" name="dept" required  placeholder="Enter your Department."/>
                            </p>
                            <p>
                                <label for="sal" class="uname" data-icon="u">Enter your contact </label>
                                <input id="sal" name="contact" required  placeholder="Enter your salary."/>
                            </p>
                            <!--<p>
