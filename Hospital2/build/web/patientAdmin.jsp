        ...
        <div class="wrap">
            <header>
                <div class="container">
                    ...
                    <nav>
                        <ul>
                            <li class="current"><a href="AdminAdd.jsp" class="m1">Patient List</a></li>
                            <li><a href="AdminEdit.jsp" class="m2">Add Patient</a></li>
                            <li><a href="SearchPatientList.jsp" class="m3">Search Patient</a></li>
                            <li><a href="uploadNotice1.jsp" class="m4">Upload notice</a></li>
            ...
            <div class="container">
                <aside>
                    ...
                    <hr>--><h3><a href="changePassword.jsp">change password</a></h3><hr>
                    <br>
                ...
                <section id="content">
                    ...
                    <div class="inside">
                        <h2><span>Patient List</span></h2><hr><br><br>
