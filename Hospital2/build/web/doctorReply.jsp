        ...
        <div class="wrap">
            <header>
                <div class="container">
                    ...
                    <nav>
                        <ul>
                            <li class="current"><a href="Admin" class="m1">Go Back</a></li>
            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <div class="inside" align="center">
                                            <div class="inside">
                        <h2>Reply <span>Module</span></h2><hr>
                        ...
                        <form action="msgDoctor.jsp" method ="post">
                         ...
                         Enter Description : 
                            <textarea name="content" placeholder="Enter Diagnosis" 
                                      rows="5" cols="20" maxlength="100" style="font-size:14px; font-family:'Comic Sans MS';font-weight:bold;"></textarea><br><br><br>
