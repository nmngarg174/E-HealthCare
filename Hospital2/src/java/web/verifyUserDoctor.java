 ...
 * @author princEvil
 */
public class verifyUserDoctor extends HttpServlet {
...
//            checkuserpass(u, p, request, response);
         ...
         //   session.setAttribute("location", location);
            ...
            //session.setAttribute("gender","gender");
            verifyDoctorName(gender, name, password, contact, dept, email, response, request);
        } finally {
            out.close();
        }
    }

    private void verifyDoctorName(String gender, String name, String password, String contact, String dept, String email, HttpServletResponse response, HttpServletRequest request) throws IOException, ServletException {
        ...
        for (Login x : data) {
            ...
            if (name.equals(x.getUsername())) {
                ...
                //out.println("<a href=Login/login.html>Try again</a>");
                String em = "<b><font size=2 color=red>Invalid Doctor Username ,Already Exists ,Please try Again!!</font></b>";
